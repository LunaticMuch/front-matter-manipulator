...
import updateDescendantProp from '../util/updateDescendantProp.js';
 ...
 */
export default function update(patterns, field, replacement, options) {
        ...
        return cleanData.map(f => {
            ...
            keyValues.forEach(function (p) {
                ...
                if (options.regex) {
                    ...
                    newVal = regex.exec(p.value);
                } else if (typeof replacement === 'function') {
                    newVal = replacement(p.value, p.permutation, f.path);
                }
